 ...
 * generated in the thehello package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorldResponse_QNAME = new QName("http://thehello/", "HelloWorldResponse");
    private final static QName _HelloWorld_QNAME = new QName("http://thehello/", "HelloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: thehello
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://thehello/", name = "HelloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://thehello/", name = "HelloWorld")
