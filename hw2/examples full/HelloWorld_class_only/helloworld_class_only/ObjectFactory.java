 ...
 * generated in the helloworld_class_only package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://HelloWorld_class_only/", "HelloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://HelloWorld_class_only/", "HelloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: helloworld_class_only
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://HelloWorld_class_only/", name = "HelloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://HelloWorld_class_only/", name = "HelloWorldResponse")
