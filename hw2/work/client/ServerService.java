    ...
    extends Service
{
    ...
    public ServerAPI getServerPort() {
        return super.getPort(new QName("http://server/", "ServerPort"), ServerAPI.class);
    }
     ...
     */
    @WebEndpoint(name = "ServerPort")
    public ServerAPI getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "ServerPort"), ServerAPI.class, features);
    }
